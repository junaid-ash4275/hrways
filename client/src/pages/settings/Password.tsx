  ...
  return (
    <div className="grid md:grid-cols-2 gap-6">
      <form onSubmit={onChangePassword} className="bg-white dark:bg-neutral-800 rounded-xl border border-gray-200 dark:border-neutral-800 p-4">
        ...
        {msg && <div className="mb-2 text-sm brand-text" role="status">{msg}</div>}
      ...
      <div className="bg-white dark:bg-neutral-800 rounded-xl border border-gray-200 dark:border-neutral-800 p-4">
        ...
        <button onClick={onRequestReset} className="px-4 py-2 rounded-lg border brand-border-soft brand-text hover:bg-emerald-50 dark:hover:bg-emerald-900/20 transition">Send reset code</button>
